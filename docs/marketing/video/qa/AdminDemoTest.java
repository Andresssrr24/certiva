...
public final class AdminDemoTest extends InstrumentationTestCase {
    ...
    private void stage(String name)throws Exception {
        android.util.Log.i("CertivaAdminDemo",name);
        write("admin-demo-progress.json",new JSONObject().put("stage",name).put("at",System.currentTimeMillis()));
    }
    ...
    public void testSameMobileCaseThroughAdminUI() throws Throwable {
        ...
        try {
            ...
            stage("rotation_set_waiting_idle");
            getInstrumentation().waitForIdleSync();
            android.os.SystemClock.sleep(800);
            stage("activity_launch_requested");
            ...
            stage("webview_attached_loading");
