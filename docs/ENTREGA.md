...
- [ ] **Al hacer público el repo, abrir el QR del README desde un teléfono sin sesión de GitHub** y comprobar que el Release apk-v0.2 descarga.
...
- [x] APK 0.3.0 publicado en el [Release apk-v0.2](https://github.com/Andresssrr24/certiva/releases/tag/apk-v0.2) (229 MB, SHA-256 `9a5165c4…5d4099`), con el README, el QR, `instalar.sh` y `mobile/certiva-release-arm64.apk.sha256` apuntando ahí.
