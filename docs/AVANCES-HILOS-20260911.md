...
| Mejorar interfaz y menú | Inicio [PR #21](https://github.com/Andresssrr24/certiva/pull/21), menú 0.4 [PR #30](https://github.com/Andresssrr24/certiva/pull/30), API36/Atrás [PR #37](https://github.com/Andresssrr24/certiva/pull/37) | Seis pruebas de menú y una con texto al 130 % aprobadas. Dos pruebas de navegación API36 ejecutadas en emulador API35; no acreditan Android16 ni instalación física desde Play. |
...
| Crear landing Certiva interactiva | Guía y QR [PR #22](https://github.com/Andresssrr24/certiva/pull/22), teléfono interactivo [PR #24](https://github.com/Andresssrr24/certiva/pull/24), registro y privacidad [PR #35](https://github.com/Andresssrr24/certiva/pull/35) | Registro Google habilitado, descarga cerrada pendiente; callback a Play preparado detrás de su bandera. Suite completa de 30 pruebas aprobada. OAuth Chrome con miembro existente comprobado por la tarea y Android confirmado por Bryan. Servicio público de reportes en PR #38 y Android0.5 en PR #37; las correcciones de cuota de la revisión siguen pendientes de despliegue. |
...
- Android nativo: [inicio y menú](ANDROID-INICIO-Y-MENU.md), [API36 y navegación, incluida en Android0.5](https://github.com/Andresssrr24/certiva/pull/37), [diagnóstico histórico Play Protect](android/PLAY-PROTECT-REVISION.md).
...
## Reportes públicos y Android0.5
