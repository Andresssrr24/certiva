...
Las PR #34 (evidencia de notificación/menú) y #35 (registro Google) ya están integradas. Quedan abiertas [PR #36](https://github.com/Andresssrr24/certiva/pull/36), API36; [PR #37](https://github.com/Andresssrr24/certiva/pull/37), Android0.5, que también incluye API36; y [PR #38](https://github.com/Andresssrr24/certiva/pull/38), servicio HTTPS de reportes. El backend se añadió después del corte fusionado de #35, por lo que necesita su PR independiente.
