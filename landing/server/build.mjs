...
let apk;
try { apk = await readFile(new URL(`../public/downloads/${manifest.apk}`, import.meta.url)); }
catch { throw new Error(`Copy the frozen pilot APK to public/downloads/${manifest.apk} before deploying. See README.`); }
