...
public final class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        text(content,"Prueba técnica. Caja de Ahorros es referencia; no hay conexión con el banco ni intervención en pagos. Android v0.1 analiza texto con reglas locales; no incluye OCR ni QVAC.",12,false);
    ...
    private void invalidate(){ revision++; assessment=null; if(resultBox!=null)resultBox.removeAllViews(); }
    ...
    private Button button(LinearLayout parent,String label,boolean primary){Button view=new Button(this);view.setText(label);view.setAllCaps(false);view.setTextColor(primary?Color.WHITE:blue);if(primary)view.setBackgroundTintList(android.content.res.ColorStateList.valueOf(blue));parent.addView(view,new LinearLayout.LayoutParams(-1,dp(54)));return view;}
    private void analyze(){
        ...
        engine.assess(message.getText().toString(),channels[channel.getSelectedItemPosition()],(result,error)->{
            ...
            if(error!=null){error(error);return;} assessment=result;resultBox.removeAllViews();
