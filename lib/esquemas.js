...
function promptVeredicto({ captura, senales, banco }) {
  const sistema = [
    ...
    "Escribe en español claro, para una persona mayor, en frases cortas. La acción debe ser concreta: qué hacer y qué no hacer.",
    "El campo canal_oficial repite el canal oficial correcto para este caso.",
    "/no_think",
  ].join(" ");
  const usuario = [
...
module.exports = { ESQUEMA_CAPTURA, ESQUEMA_VEREDICTO, PROMPT_CAPTURA, promptVeredicto };
