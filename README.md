...
| App Android con QVAC (Expo) | [APK de 228 MB](https://github.com/Andresssrr24/certiva/releases/tag/apk-v0.1) compilado y probado en emulador arm64: texto por reglas en 1 ms; VisionPsy Q8 se descarga desde la app y leyó capturas en CPU (31 a 43 s) | [Guía](mobile/README.md) · [Plan y mediciones](docs/PLAN-APK.md). Pendiente: prueba en teléfono físico con GPU |
